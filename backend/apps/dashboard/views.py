...
PATCH_NOTES = [
    ...
    },
    {
        'version': '0.1.12',
        'date': '2026-05-20',
        'title': 'Оборудование в инвентаризации по локации',
        'summary': 'В акт инвентаризации теперь можно добавить оборудование выбранной локации, даже если юрлицо отличается.',
        'items': [
            'Оборудование Test теперь появится в акте по локации Шерегеш.',
            'В выпадающем списке видно название, инвентарный номер, юрлицо и склад.',
            'Позиции, уже добавленные в акт, скрываются из списка выбора.',
        ],
    },
    {
        'version': '0.1.11',
        'date': '2026-05-20',
        'title': 'Русская форма юрлиц',
        'summary': 'Форма создания и редактирования юридических лиц теперь полностью на русском языке.',
        'items': [
            'Поле name отображается как "Название".',
            'Поле short_name отображается как "Краткое название".',
            'Поле tax_id отображается как "ИНН", а is_active как "Активно".',
        ],
    },
    {
        'version': '0.1.10',
